...
STATIC_DIR_P13=os.path.join(os.path.join(BASE_DIR,'p13'),'static')
...
SECRET_KEY = 'django-insecure-7peaknv!rpr^l%hp^#$exsat)gj%fi#!pfk@g1j+3e1_)zx*m-'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [STATIC_DIR_P13,STATIC_DIR_APP]
